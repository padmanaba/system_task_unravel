  ...
  @csrf <!-- {{ csrf_field() }} -->
    <div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        {!! Form::text('item_name', old('item_name'), ['class' => 'form-control', 'id' => 'input_item_name', 'placeholder' => 'ItemName']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        {!! Form::text('item_description', old('item_description'), ['class' => 'form-control', 'id' => 'input_item_description', 'placeholder' => 'ItemDescription']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <!-- <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pwd"> -->
        {!! Form::text('item_amount', old('item_amount'), ['class' => 'form-control', 'id' => 'input_item_amount', 'placeholder' => 'Amount']) !!}
